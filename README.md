...
gcp-oidc-token-proxy:
  ...
  depends_on:
  - prometheus
  image: ghcr.io/dazwilkin/gcp-oidc-token-proxy:55c6d2445bd14f4da51d8f02b156b3a03bef3c3d
...
ghcr.io/dazwilkin/gcp-oidc-token-proxy:55c6d2445bd14f4da51d8f02b156b3a03bef3c3d \
--target_url=${ENDPOINT} \
--port=${PORT}
```
