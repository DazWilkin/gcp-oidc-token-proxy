...
gcp-oidc-token-proxy:
  ...
  depends_on:
  - prometheus
  image: ghcr.io/dazwilkin/gcp-oidc-token-proxy:89c7784453dc0f52d53c80ca693a0cb30ef8641d
...
ghcr.io/dazwilkin/gcp-oidc-token-proxy:89c7784453dc0f52d53c80ca693a0cb30ef8641d \
  --target_url=${ENDPOINT} \
  --port=${PORT}
```
